...
if(mysqli_num_rows($result)>0){
    echo "<table border=1 bordercolor='gold'><tr><th>id</th><th>name</th><th>description</th><th>price</th><th></th></tr>";
    while($row=mysqli_fetch_assoc($result)){
    echo "<tr><td>".$row["id"]."</td><td>".$row["name"]."</td><td>";
    echo $row["des"]."</td><td>".$row["price"]."</td></tr>";
